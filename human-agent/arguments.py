...
class ModelArguments:
    ...
    model_name_or_path: str = field(
        default="/home/fengxueyang/rl/gradient_human/pretrain_model/llama_hf",
    ...
    tokenizers: Optional[str] = field(
        default="/home/fengxueyang/rl/gradient_human/pretrain_model/llama_hf", metadata={"help": "Path to pretrain tokenizer"}
    )
